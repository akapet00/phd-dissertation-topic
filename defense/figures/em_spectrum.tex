...
\begin{figure}[ht]
    ...
    \caption{Diagram of the EM spectrum as a function of wavelength. \emph{Ionizing radiation} occurs when a photon’s energy is greater than \SI{10}{\eV} -- below the lower end of ultraviolet (UV) spectrum. Visible light, infrared (IR), RF and low-frequency (LF) radiation is thus considered \emph{non-ionizing}.}
